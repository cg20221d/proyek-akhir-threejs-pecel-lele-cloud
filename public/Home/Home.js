...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Icosphere001.geometry} material={materials.Material} position={[-4.54, 3.44, 4.91]} scale={0.83}>
      ...
      <mesh geometry={nodes.Plane002.geometry} material={materials.sofa} position={[0.51, 0.57, 10.07]} rotation={[0, -Math.PI / 2, 0]} scale={[2.68, 0.87, 0.87]}>
        <mesh geometry={nodes.Plane003.geometry} material={materials['bantal sofa']} />
      </mesh>
      <group position={[2.18, 0.44, 10.01]} scale={3}>
      ...
      <group position={[-1.7, -14.69, 27.23]} scale={[1.69, 1.9, 1.85]}>
      ...
      <mesh geometry={nodes.Plane004.geometry} material={nodes.Plane004.material} position={[4.88, 2.94, 7.12]} rotation={[0, 0, -Math.PI / 2]} />
      <group position={[2.21, 5.42, 10.02]} scale={[3.13, 1, 4.92]}>
      ...
      <mesh geometry={nodes.Plane007.geometry} material={materials['Material.022']} position={[1.17, 0, 2.35]} rotation={[0, Math.PI / 2, 0]} scale={[12.93, 8, 6.63]} />
      <mesh geometry={nodes.Plane008.geometry} material={materials['Material.017']} position={[0.79, 0.49, 2.4]} rotation={[0, Math.PI / 2, 0]} scale={0.68}>
      ...
      <mesh geometry={nodes.Plane016.geometry} material={materials.pagar} position={[-8.95, 0.95, 0.19]} scale={[1.3, 1, 0.24]}>
      ...
      <mesh geometry={nodes.Icosphere004.geometry} material={materials.Material} position={[-4.54, 3.44, -8.44]} scale={0.83}>
      ...
      <mesh geometry={nodes.Icosphere007.geometry} material={materials.Material} position={[4.69, 3.44, -8.44]} scale={0.83}>
      ...
      <mesh geometry={nodes.Plane019.geometry} material={materials['Material.018']} position={[-3.5, 1.99, -1.7]} rotation={[Math.PI, 0, 0.93]} scale={[0.75, 1, 0.17]}>
      ...
      <mesh geometry={nodes.Plane013.geometry} material={materials['Material.018']} position={[5.08, 1.99, 0.37]} rotation={[0, 0, -2.21]} scale={[0.75, 1, 0.17]}>
      ...
      <mesh geometry={nodes.Plane015.geometry} material={materials.pagar} position={[-1.04, 0.95, 0.19]} scale={[1.3, 1, 0.24]}>
      ...
      <mesh geometry={nodes.Plane020.geometry} material={materials.pagar} position={[5.35, 0.95, 5.39]} rotation={[0, Math.PI / 2, 0]} scale={[1.3, 1, 0.24]}>
      ...
      <mesh geometry={nodes.Plane021.geometry} material={materials.pagar} position={[18.38, 0.95, 5.39]} rotation={[0, Math.PI / 2, 0]} scale={[1.3, 1, 0.24]}>
